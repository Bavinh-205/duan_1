                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy Cập Vào Danh Sách Đơn Hàng </li>
                                    </ol>
                                </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="inputStatus" name="trang_thai_id" class="form-control custom-select">
                                                                <?php foreach ($trangThais as $trangthai) : ?>
                                                                    <option <?= $trangthai['id'] == $DonHangs['trang_thai_id'] ? 'selected' : '' ?> value="<?= $trangthai['id'] ?>"><?= $trangthai['ten_trang_thai'] ?></option>
                                                                <?php endforeach; ?>
