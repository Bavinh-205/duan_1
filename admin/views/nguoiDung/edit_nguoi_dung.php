                ...
                <div class="container-fluid">
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Cập Nhật Danh Sách Người Dùng </h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập tên người dùng" name="ten_nguoi_dung"    value="<?=$nguoiDungs['ten_nguoi_dung'] ?>">
                                                ...
                                                <!--end col-->
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Email" name="email" value="<?=$nguoiDungs['email'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Số Điện Thoại" name="sdt" value="<?=$nguoiDungs['sdt'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập địa Chỉ" name="dia_chi" value="<?=$nguoiDungs['dia_chi'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập mật khẩu" name="pass" value="<?=$nguoiDungs['pass'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập Ngày Sinh" name="ngay_sinh" value="<?=$nguoiDungs['ngay_sinh'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="gioi_tinh">
                                                            ...
                                                            <option value="1" <?= $nguoiDungs['gioi_tinh']==1 ? 'selected' : '' ?>>Nam</option>
                                                            <option value="2" <?= $nguoiDungs['gioi_tinh']==2 ? 'selected' : '' ?>>Nữ</option>
                                                        </select>
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <img src="<?= $nguoiDungs['avatar'] ?>" alt="Hình ảnh" width="80px">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="vai_tro">
                                                            ...
                                                            <option value="2" <?= $nguoiDungs['vai_tro']==2 ? 'selected' : '' ?>>Khách Hàng</option>
                                                        </select>
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="trang_thai">
                                                            ...
                                                            <option value="1" <?= $nguoiDungs['trang_thai']==1 ? 'selected' : '' ?>>Hoạt Động</option>
                                                            <option value="2" <?= $nguoiDungs['trang_thai']==2 ? 'selected' : '' ?>>Đã Block</option>
                                                        </select>
                                                        <span class="text-danger">
