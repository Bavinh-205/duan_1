                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy cập vào danh scahs người dùng </li>
                                    </ol>
                                </div>
                            ...
                            <div class="h-100">
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=from-them-nguoi-dung" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Thêm Người Dùng</a>
                                    </div><!-- end card header -->
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($nguoiDungs as $index => $nguoiDung) : ?>
                                                            <tr>
                                                                ...
                                                                <td><img style="width: 80px; height: 100px;" src="<?= $nguoiDung['avatar'] ?> " alt=""></td>
                                                                <td>
                                                                    <?php
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                        <span class="badge bg-danger">Đã block</span>
                                                                ...
                                                                <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        <a href="?act=form-sua-nguoi-dung&danh_muc_id=<?= $nguoiDung['id'] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                        <form action="?act=xoa-nguoi-dung" method="post"
                                                                            onsubmit="return confirm('bạn có chắc chắn xóa')">
                                                                            <input type="hidden" name="danh_muc_id" value="<?= $nguoiDung['id'] ?>">
