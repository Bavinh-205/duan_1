                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy cập vào trang tin tức </li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <form action="?act=sua-tin-tuc" method="POST">
                                                <input type="hidden" class="form-control" name="id" value="<?= $danhMucs['id']; ?>">
                                                <input type="hidden" name="id" value="<?= $danhMucs['id'] ?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="citynameInput" class="form-label">Têu Đề</label>
                                                            <input type="text" class="form-control" placeholder="Nhập tên tin tức" name="tieu_de" value="<?= $danhMucs['tieu_de']; ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nhập tên tin tức" name="noi_dung" value="<?= $danhMucs['noi_dung']; ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="Nhập tên tin tức" name="ngay_tao" value="<?= $danhMucs['ngay_tao']; ?>">
                                                            <span class="text-danger">
