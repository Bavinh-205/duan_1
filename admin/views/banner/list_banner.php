                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy cập vào banner </li>
                                    </ol>
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="?act=from-them-banner" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Thêm banner</a>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img style="width: 80px; height: 100px;" src="<?= $banner['hinh_anh'] ?> " alt=""></td>
