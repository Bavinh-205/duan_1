                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy cập vào Trang Liên Hệ </li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="live-preview">
                                        <form action="?act=sua-lien-he" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Email Liên Hệ</label>
                                                        <input type="text" class="form-control" placeholder="Nhập Email Liên Hệ" name="email" value="<?=$danhMucs['email']?>">
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Nội dung" name="noi_dung" value="<?=$danhMucs['noi_dung']?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập Địa Chỉ" name="ngay_tao" value="<?=$danhMucs['ngay_tao']?>">
                                                        <span class="text-danger">
